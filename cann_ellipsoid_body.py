...
vels = ImpulseDict(
    ...
    N=4,
    id={1: ((5.0, 11.0),), 0: ((11.0, 15.0),), 2: ((19.0, 25.0),), 3: ((25.0, 29.0),)},
)
...
dir_impl = ImpulseDict(
    N=N_theta,
    id={8: ((1.0, 2.0),), 4: ((32.0, 34.0),), 1: ((36.0, 38.0),), 3: ((41.0, 43.0),)},
)
...
cols = list(np.arange(vels.N) + 0.5 - vels.N / 2.0)
rows = [0] * len(cols)
vel_row = ax1.scatter(
